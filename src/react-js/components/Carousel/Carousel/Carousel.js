      ...
      >
        {indicators && childrenCount > 0 && (
          <div
            ...
            data-testid={`carousel-indicators${props.id ? `-${props.id}` : ''}`}
          >
        ...
        <div
          className={innerFullClassName}
          data-testid={`carousel-inner${props.id ? `-${props.id}` : ''}`}
        >
          {children}
        </div>
        ...
        {controls && childrenCount > 1 && (
          <>
            <button
              ...
              aria-label="Previous"
              disabled={isTransitioning}
              data-testid={`carousel-control-prev${props.id ? `-${props.id}` : ''}`}
            >
              <span
                className={getFullClassName(
            ...
            <button
              ...
              aria-label="Next"
              disabled={isTransitioning}
              data-testid={`carousel-control-next${props.id ? `-${props.id}` : ''}`}
            >
              <span
                className={getFullClassName(
