...
describe("ButtonBaseComponent", () => {
  ...
  it("does not apply prefixed bsClasses when useBsClasses is false", () => {
    render(<ButtonBaseComponent bsClasses="btn btn-primary" useBsClasses={false}>Test</ButtonBaseComponent>);
  ...
  it("appends additional className prop", () => {
    render(<ButtonBaseComponent bsClasses="btn" className="extra-class">Test</ButtonBaseComponent>);
    const btn = screen.getByRole("button");
  ...
  it("passes other props to the button", () => {
    ...
    render(<ButtonBaseComponent bsClasses="btn" type="submit" onClick={handleClick}>Test</ButtonBaseComponent>);
    const btn = screen.getByRole("button");
